    ...
    <section id="main-visual">
        <div class="main-box">
            <div class="main-text">
                ...
                <div class="main-text--items">
                    <p>ここはわたしの作品たちを掲載させていただいているサイトです<br>たくさんのことを学び、たくさんの知識を詰め込んでおります</p>
    ...
    <section id="products">
        <div class="wrapper">
            <div class="title">
                ...
                <h3 class="text">
                    どこにあるんだろう？がなくなるサイト作りを心がけております<br>いちばん必要な情報を、いちばんに得られることが、いちばん大事ですね
                </h3>
            </div>
    ...
    <div class="container">
        <section id="production">
            <div class="title">
                ...
                <p class="text">
                    サイトの訪問者は必ず疑問、興味、知りたいことを持って訪れています<br>
                    ...
                    <div class="flex">
                        <div>
                            ...
                            <ul class="process-box--parts">
                                <li class="process-box--list">お話しをいただきましたら急ぎ対応中以外<br>すぐにどちらでも駆けつけます（旅費の関係で可能な限りリモートでの対応をお願いしております、すみません…）</li>
