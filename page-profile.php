...
<main id="main">
    <section id="profile">
        ...
        <div class="main-profile flex">
            <!-- <img class="main--profle-img" src="profile_t.JPG" alt="プロフィール画像"> -->
            <div>
                <h2 class="main-profile--name">Fujichi</h2>
                <h3 class="main-profile--detail">1987年12月19日生まれ</h3>
                <h3 class="main-profile--detail">北海道札幌市住み</h3>
                <p class="main-profile--text">白米を愛する人間</p>
                <div class="cv">
                    <h3>略歴</h3>
                    <table class="cv-table">
                        ...
                        <tr>
                            ...
                            <td class="cv-text">勉強し始めるととても楽しく、とても難しい。本腰を入れて勉強し始める。メンターさんにサポートしていただく。</td>
                        </tr>
                        <tr>
                            <th class="cv-year">2021.11</th>
                            <td class="cv-text">以下勉強をメンターさんにサポートいただいた上、知識を身に着ける。</td>
                        </tr>
                        <tr>
                            <th class="cv-year">現在</th>
                            <td class="cv-text">勉強をし続けて役に立てるよう知識を追い求めていく。</td>
                        </tr>
                    </table>
                </div>
            </div>
